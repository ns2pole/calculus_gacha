 ...
 *   node ../tool/generate-starter-quick-replies.mjs
 *
 * Options:
 *   --resume     skip IDs already in tool/starter_replies_progress.json
...
const manifestPath = join(root, "tool/starter_problems_manifest.json");
const progressPath = join(root, "tool/starter_replies_progress.json");

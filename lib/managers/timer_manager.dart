...
class TimerManager {
  ...
  final ValueNotifier<int> remainingSecondsNotifier = ValueNotifier<int>(600);
  ...
  Future<void> loadTimerSettings(String prefsPrefix) async {
    ...
    _timerMinutes = settings['timerMinutes'] as int? ?? 10;
    _remainingSeconds = settings['remainingSeconds'] as int? ?? (_timerMinutes * 60);

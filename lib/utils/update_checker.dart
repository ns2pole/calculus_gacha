...
class UpdateChecker {
  ...
  void _showUpdateDialog(
    ...
    final dialogTitle = localizations?.updateDialogTitle ?? 'New update available';
    final dialogMessage = localizations?.updateDialogMessage ?? 'Would you like to update?';
    final dialogLaterText = localizations?.updateDialogLater ?? 'Later';
    final dialogUpdateText = localizations?.updateDialogUpdate ?? 'Update';
    final dialogReleaseNotesLabel = localizations?.updateDialogReleaseNotes ?? 'Release notes';
        ...
        content: Column(
          ...
          children: [
            ...
            if (storeInfo != null) ...[
              ...
              Text(
                (localizations != null) ? localizations.storeVersionLabel(storeInfo) : 'Store version: $storeInfo',

...
import '../pages/gacha/gacha_settings_page.dart';
...
Future<ProgressInfo> getGachaProgress({
  ...
  // 全問題数を取得（共通関数を使用）
  final totalCount = getTotalProblemCount(
  ...
  if (filterModeStr != null) {
    ...
    final filterDescription = needed > 0 ? l10n.latestNPrefix(needed) : l10n.allDisplayed;
